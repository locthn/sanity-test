...
WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_filiale_wuppertal/hyperlink_object'), 20, FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.enhancedClick(findTestObject('AI-Generated/Page_filiale_wuppertal/hyperlink_object'))
