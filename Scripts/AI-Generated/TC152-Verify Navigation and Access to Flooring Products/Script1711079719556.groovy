...
WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_anmeldung/div_usercentrics_root'), 20, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/anmeldung && ?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_anmeldung/div_usercentrics_root'))
...
"Step 11: Click on link  -> Navigate to page 'alle-produkte/* && laminat/*'"
...
WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_alle_produkte/img_object'), 20, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/alle-produkte/.* && laminat/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_alle_produkte/img_object'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC152-Verify Navigation and Access to Flooring Products_visual_checkpoint')
