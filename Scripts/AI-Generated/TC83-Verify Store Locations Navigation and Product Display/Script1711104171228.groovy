...
"Step 2: Click on div 'usercentrics-root' -> Navigate to page 'filiale/wuppertal && filiale/bielefeld && filiale/muelheim && filiale/gelsenkirchen && filiale/dortmund && filiale/porta-westfalica && filiale/hamm'"
...
WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/filiale/wuppertal && filiale/bielefeld && filiale/muelheim && filiale/gelsenkirchen && filiale/dortmund && filiale/porta-westfalica && filiale/hamm?/?(?:#.*)?(?:\\?.*)?$', true)
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC83-Verify Store Locations Navigation and Product Display_visual_checkpoint')
