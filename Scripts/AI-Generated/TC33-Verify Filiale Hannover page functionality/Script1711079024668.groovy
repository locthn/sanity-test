...
"Step 1: Navigate to https://stackoverflow.com/filiale/hannover && filiale/bietigheim && filiale/essen && filiale/hamm && filiale/porta-westfalica && filiale/velbert && filiale/muelheim && filiale/iserlohn && filiale/gelsenkirchen && filiale/solingen && filiale/dortmund && filiale/duisburg && filiale/wuppertal && filiale/paderborn && filiale/hamburg && filiale/bielefeld && filiale/bochum && filiale/lippstadt"

WebUI.navigateToUrl(GlobalVariable.application_domain + '/filiale/hannover && filiale/bietigheim && filiale/essen && filiale/hamm && filiale/porta-westfalica && filiale/velbert && filiale/muelheim && filiale/iserlohn && filiale/gelsenkirchen && filiale/solingen && filiale/dortmund && filiale/duisburg && filiale/wuppertal && filiale/paderborn && filiale/hamburg && filiale/bielefeld && filiale/bochum && filiale/lippstadt')
...
WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/filiale/hannover && filiale/bietigheim && filiale/essen && filiale/hamm && filiale/porta-westfalica && filiale/velbert && filiale/muelheim && filiale/iserlohn && filiale/gelsenkirchen && filiale/solingen && filiale/dortmund && filiale/duisburg && filiale/wuppertal && filiale/paderborn && filiale/hamburg && filiale/bielefeld && filiale/bochum && filiale/lippstadt?/?(?:#.*)?(?:\\?.*)?$', true)
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC33-Verify Filiale Hannover page functionality_visual_checkpoint')
