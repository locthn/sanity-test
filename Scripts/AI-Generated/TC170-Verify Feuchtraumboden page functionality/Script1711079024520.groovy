...
"Step 4: Click on link  -> Navigate to page 'feuchtraumboeden/* && bioboeden/*'"
...
WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/feuchtraumboeden/.* && bioboeden/.*?/?(?:#.*)?(?:\\?.*)?$', true)
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC170-Verify Feuchtraumboden page functionality_visual_checkpoint')
