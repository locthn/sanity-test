...
WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_home/li_object_3'), 20, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_home/li_object_3'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC32-Verify Account Details Page Display_visual_checkpoint')
