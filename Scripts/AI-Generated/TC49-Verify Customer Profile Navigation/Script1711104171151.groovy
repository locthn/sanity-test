...
WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_customer_profile/div_object_9'), 20, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/customer/profile/.*?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_customer_profile/div_object_9'))

"Step 6: Click on button 'scrollable-auto-tab-1'"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC49-Verify Customer Profile Navigation_visual_checkpoint')
