...
WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_vinylboeden/button_38_artikel_anzeigen'), 20, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/vinylboeden?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_vinylboeden/button_38_artikel_anzeigen'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Verify Successful Navigation and Page Verification_visual_checkpoint')
